...
public class RepairStarCommand implements CommandExecutor {

	@Override
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		String command = "giverepairstar";
		if (label.equalsIgnoreCase(command) || label.equalsIgnoreCase("givers")) {
			if(sender.hasPermission("core.give")) {
				ItemStack theItem = getRepairStar();
	...
	private ItemStack getRepairStar() {
		return ItemConfigurationLoader.getLoadedConfig().get("RepairStar");
	}
}
