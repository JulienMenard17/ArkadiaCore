...
public class RandomOreCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		String command = "giverandomore";
		if (label.equalsIgnoreCase(command) || label.equalsIgnoreCase("givero")) {
			if(sender.hasPermission("core.give")) {
				ItemStack theItem = getRandomOre();
	...
	private ItemStack getRandomOre() {
		return ItemConfigurationLoader.getLoadedConfig().get("RandomOre");
	}
}