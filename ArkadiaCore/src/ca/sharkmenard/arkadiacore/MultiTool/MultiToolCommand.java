...
public class MultiToolCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		String command = "givemultitool";
		if (label.equalsIgnoreCase(command) || label.equalsIgnoreCase("givemt")) {
			if(sender.hasPermission("core.give")) {
				ItemStack theItem = getMultiTool();
	...
	private ItemStack getMultiTool() {
		return ItemConfigurationLoader.getLoadedConfig().get("MultiTool");
	}
}
